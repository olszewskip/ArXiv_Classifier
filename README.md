...
Comape loss-functions/batch-sizes/optimizers and pretrain word-embeddings | [keras_simpleGridSearch.ipynb](https://github.com/olszewskip/ArXiv_Classifier/blob/master/keras_simpleGridSearch.ipynb) | custom loss functions are helpful
